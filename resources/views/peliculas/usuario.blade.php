                          ...
                          <div class="col align-self-start">
                            <div class="row row-cols-1 row-cols-md-6 g-4" >
                              @foreach($usuario as $usuarios)
                                <div class="col">
                                    @if($usuarios->foto)
                                    <a href="{{route('usuarios.edit', $usuarios->id)}}"><img style="width: 100px; height: 100px;" src="/storage/fotos/{{$usuarios->foto}}" class="card-img-top" alt=""></a>
                                    @endif
                                    <div class="card-body">
                                      <p class="card-text" style="color: rgb(255, 255, 255);">{{$usuarios->nombre}}</p>
                                    </div>
                                </div>
                              @endforeach
                          </div>
