                  ...
                  <div class="card text-white" style="border-radius: 1rem; background-color: rgb(23, 28, 44); width: 1500px; height: 600px;">
                    ...
                    <div class="container text-center">
                        <div class="row">
                          <div class="col align-self-start">
                            <div class="row row-cols-1 row-cols-md-6 g-4" >
                              @foreach($generos as $genero)
                                <div class="col">
                                    @if($genero->foto)
                                    <a href="{{route('generos.edit', $genero->id)}}"><img style="width: 100px; height: 100px;" src="/storage/fotos/{{$genero->foto}}" class="card-img-top" alt=""></a>
                                    @endif
                                    <div class="card-body">
                                      <p class="card-text" style="color: rgb(255, 255, 255);">{{$genero->nombre}}</p>
                                    </div>
                                </div>
                              @endforeach
                          </div>
                          ...
                          <div class="col">
                            <div>
                                <button class="btn px-2" style="background-color: rgb(62, 62, 94); color: #ffffff;" type="submit"> <a href="{{route('generos.create')}}">Añadir</a></button>
                            </div>     
                          </div>
                        </div>
                      </div>
