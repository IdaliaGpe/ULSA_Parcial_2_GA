                        ...
                        <form action="{{route('usuarios.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row ">
                                    ...
                                    <div class="col p-5">
                                        ...
                                        <br>
                                        <br>
                                        <h2 class="fw-bold mb-3  text-uppercase text-center">Añadir Usuario</h2>
                                        <br>
                
                                        <div class="form-outline form-white mb-4 mt-2">
                                        <label class="form-label" >Nombre</label>
                                        <input name="nombre" type="text" class="form-control form-control-lg" placeholder="Insertar nombre..."/>
                                        </div>
